...
<head>
    ...
    @if (\Route::currentRouteName() == 'property' || \Route::currentRouteName() == 'agency-property')
        <title>{{ $property->seo && $property->seo->seo_title ? $property->seo->seo_title : config('app.name', 'BookingFWI') }}</title>

        <meta property="og:type" content="website">
        <meta property="og:site_name" content="{{ $sitemeta && $sitemeta->website_title != "" ? $sitemeta->website_title : 'BookingFWI' }}">
        <meta property="og:title" content="{{ $property->seo && $property->seo->seo_title ? $property->seo->seo_title : ($sitemeta && $sitemeta->title != "" ? $sitemeta->title : 'BookingFWI | The best vacation rentals in St Barts & Saint-Martin') }}">
        <meta property="og:description" content="{{ $property->seo && $property->seo->seo_title ? $property->seo->seo_title : ($sitemeta && $sitemeta->description != "" ? str_replace('<br>', "\n", $sitemeta->description) : 'Are you looking to rent a villa with swimming pool, a village house, an apartment or a room in St Barts, Saint-Martin , Sint Maarten? All year round, we have the vacation rental') }}">
        <meta property="og:url" content="{{ url()->current() }}">
        <meta property="og:image" content="{{ $property->allphotos->count() > 0 ? asset($property->allphotos[0]->photo) : asset($logo) }}">
        <meta name="twitter:title" content="{{ $property->seo && $property->seo->seo_title ? $property->seo->seo_title : ($sitemeta && $sitemeta->title != "" ? $sitemeta->title : 'BookingFWI | The best vacation rentals in St Barts & Saint-Martin') }}">
        <meta name="twitter:description" content="{{ $property->seo && $property->seo->seo_title ? $property->seo->seo_title : ($sitemeta && $sitemeta->description != "" ? str_replace('<br>', "\n", $sitemeta->description) : 'Are you looking to rent a villa with swimming pool, a village house, an apartment or a room in St Barts, Saint-Martin , Sint Maarten? All year round, we have the vacation rental') }}">
        <meta name="twitter:image:src" content="{{ $property->allphotos->count() > 0 ? asset($property->allphotos[0]->photo) : asset($logo) }}">
        <meta name="twitter:url" content="{{ url()->current() }}">
        <meta name="twitter:domain" content="View website">
        <meta name="name" content="{{ $property->seo && $property->seo->seo_title ? $property->seo->seo_title : ($sitemeta && $sitemeta->title != "" ? $sitemeta->title : 'BookingFWI | The best vacation rentals in St Barts & Saint-Martin') }}">
        <meta name="description" content="{{ $property->seo && $property->seo->seo_title ? $property->seo->seo_title : ($sitemeta && $sitemeta->description != "" ? str_replace('<br>', "\n", $sitemeta->description) : 'Are you looking to rent a villa with swimming pool, a village house, an apartment or a room in St Barts, Saint-Martin , Sint Maarten? All year round, we have the vacation rental') }}">
        <meta name="image" content="{{ $property->allphotos->count() > 0 ? asset($property->allphotos[0]->photo) : asset($logo) }}">
        <meta name="keywords" content="{{ $property->seo && $property->seo->seo_title ? $property->seo->seo_title : ($sitemeta && $sitemeta->keywords) }}">
    @else
...
<body {{ \Route::currentRouteName() == 'locations' ? 'id=locations-body' : '' }}>
    <div id="app">
        <header>
        ...
        @if (\Route::currentRouteName() != 'locations' && \Route::currentRouteName() != 'agency-locations')
        <footer>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $('.datepicker.start:not(.get-checkout)').datepicker({
                    format: "dd.mm.yy",
                    startDate: new Date(),
                    datesDisabled: {!! isset($property) ? $property->notAvailableDates() : "['']" !!},
                    autoclose: true,
                ...
                $('.datepicker.start.get-checkout').datepicker({
                    format: "dd.mm.yy",
                    startDate: new Date(),
                    datesDisabled: {!! isset($property) ? $property->notAvailableDates() : "['']" !!},
                    autoclose: true,
        ...
        @if (isset($adminData))
            <script type="text/javascript">
                function initMap() {
                    const mapOptions = {
                        zoom: 15,
                        center: { lat: {{ $adminData->place_lat }}, lng: {{ $adminData->place_lng }} },
                    };
                    map = new google.maps.Map(document.getElementById("mapContact"), mapOptions);
                    const marker = new google.maps.Marker({
                        position: { lat: {{ $adminData->place_lat }}, lng: {{ $adminData->place_lng }} },
                        map: map,
                    });
                }
                initMap();
